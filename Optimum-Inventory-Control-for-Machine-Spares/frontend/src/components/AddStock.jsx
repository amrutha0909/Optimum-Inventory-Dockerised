...
const AddStock = () => {
  ...
  const handleRestock = async (e) => {
    ...
    try {
      await axios.patch(
        `${API_BASE}/api/spares/${selectedSpare}/restock`,
        {
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <header>
        ...
        <p className="text-slate-500 mt-1">
          Record new shipments and update inventory levels
        </p>
      </header>
          ...
          <form onSubmit={handleRestock} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-4">
                ...
                <button
                  type="submit"
                  className="h-full px-8 py-4 bg-indigo-600 text-white font-bold rounded-xl shadow-lg shadow-indigo-200 hover:bg-indigo-700 transition flex items-center gap-2"
                >
                  <PackagePlus size={20} />
                  Restock
                </button>
        ...
        <div className="bg-slate-900 p-8 rounded-2xl shadow-xl text-white h-fit">
          ...
          <div className="mt-8 pt-6 border-t border-white/10 text-center">
            <p className="text-xs text-slate-500">
              Need to create a brand new item?
            </p>
